#!/usr/bin/env python3
"""
Compare base model vs fine-tuned model outputs for Training 004 (5e-5 learning rate).
"""
...
def compare_models(base_model_path, adapter_path, max_tokens=100):
    ...
    print("=" * 70)
    print("BEFORE/AFTER COMPARISON: Training 004 (LR 5e-5)")
    print("=" * 70)
...
def generate_markdown_doc(results, output_path):
    ...
    md_content = """# Training 004: Before/After Comparison
...
"""
    ...
    md_content += """## Training 003 vs Training 004 Comparison
...
def main():
    ...
    adapter_path = "outputs/adapters_lr_5e-5"
    output_json = "outputs/comparison_004_results.json"
    output_md = "docs/comparison-004-charactereval-lr5e-5.md"
